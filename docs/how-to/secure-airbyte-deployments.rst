...
Airbyte can terminate Transport Layer Security (TLS) at the ingress by leveraging the `Nginx Ingress Integrator Charm <https://charmhub.io/nginx-ingress-integrator>`_.
...
To enable Google OAuth, you need a Google Cloud project. You can create one `here <https://console.cloud.google.com/projectcreate>`_.
