...
For this tutorial, you will use `MicroK8s <https://microk8s.io/docs>`_, a lightweight distribution of K8s. 
...
.. note::
   This charm requires juju with channel >= 3.1.
...
**See next:** :doc:`Deploy supporting charms <03-deploy-supporting-charms>`
